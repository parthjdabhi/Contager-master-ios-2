...
class FacebookViewController: UIViewController {
    ...
    func setupSubviews() {
        ...
        showFriendsButton.addTarget(self, action: #selector(FacebookViewController.showFriends), forControlEvents: .TouchUpInside)
...
//        btnFacebook.delegate = self
    ...
    // Get User's Facebook Profile Data: First Name, Last Name, Profile Picture
    func loginButton(loginButton: FBSDKLoginButton!, didCompleteWithResult result: FBSDKLoginManagerLoginResult!, error: NSError!)
    {
